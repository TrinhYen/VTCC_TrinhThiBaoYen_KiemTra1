...
public class Main {
    public static void main(String[] args) throws InterruptedException {
        ...
        //Name
        driver.findElement(By.xpath("//input[@id='name']")).sendKeys("Coffee");
        ...
        //Meta description
        driver.findElement(By.xpath("//textarea[@name='meta_description']")).sendKeys("Test of Yenttb");
        Thread.sleep(1000);
